...
use PNS\Admin\Form;
use PNS\Admin\Grid;
use PNS\Admin\Http\Actions\Extensions\InstallFromLocal;
use PNS\Admin\Http\Actions\Extensions\Marketplace;
use PNS\Admin\Http\Displayers\Extensions;
use PNS\Admin\Http\Repositories\Extension;
use PNS\Admin\Layout\Content;
use PNS\Admin\Support\Helper;
use PNS\Admin\Support\StringOutput;
        ...
        return new Grid(new Extension(), function (Grid $grid) {
            ...
            $grid->quickCreate(function (Grid\Tools\QuickCreate $create) {
                ...
                $create->text('namespace')
                    ->attribute('style', 'width:240px')
                    ->placeholder('Input Namespace. Eg: PNSAdmin\\Demo');
                $create->select('type')
