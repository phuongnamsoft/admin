...
use PNS\Admin\Admin;
use PNS\Admin\Http\Auth\Permission;
use PNS\Admin\Layout\Content;
use PNS\Admin\Scaffold\ControllerCreator;
use PNS\Admin\Scaffold\LangCreator;
use PNS\Admin\Scaffold\MigrationCreator;
use PNS\Admin\Scaffold\ModelCreator;
use PNS\Admin\Scaffold\RepositoryCreator;
        ...
        try {
            ...
            if (in_array('migrate', $creates) || in_array('controller', $creates)) {
                try {
                    ...
                    $paths['ide-helper'] = 'pns_admin_ide_helper.php';
                } catch (\Throwable $e) {
                }
            }
