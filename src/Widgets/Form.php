...
use PNS\Admin\Form\Concerns\HandleCascadeFields;
use PNS\Admin\Form\Concerns\HasLayout;
use PNS\Admin\Form\Concerns\HasRows;
use PNS\Admin\Form\Concerns\HasTabs;
use PNS\Admin\Form\Field;
use PNS\Admin\Form\ResolveField;
use PNS\Admin\Support\Helper;
use PNS\Admin\Traits\HasAuthorization;
use PNS\Admin\Traits\HasFormResponse;
use PNS\Admin\Traits\HasHtmlAttributes;
...
class Form implements Renderable
{
    ...
    public function validate(Request $request)
    {
        ...
        /** @var \PNS\Admin\Form\Field $field */
        foreach ($this->fields() as $field) {
    ...
    {
        $class = Arr::get(\PNS\Admin\Form::extensions(), $method);
