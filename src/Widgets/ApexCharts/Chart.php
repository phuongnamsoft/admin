...
namespace PNS\Admin\Widgets\ApexCharts;

use PNS\Admin\Support\Helper;
use PNS\Admin\Support\JavaScript;
use PNS\Admin\Traits\InteractsWithApi;
use PNS\Admin\Widgets\Widget;
...
JS;
    ...
    public function addScript()
    {
        ...
        $this->fetched(
            <<<JS
if (! response.status) {
    return PNS.error(response.message || 'Server internal error.');
}
