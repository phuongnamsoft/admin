 ...
 * Class Admin.
 *
 * @method static \PNS\Admin\Grid grid($model, \Closure $callable)
 * @method static \PNS\Admin\Form form($model, \Closure $callable)
 * @method static \PNS\Admin\Show show($model, $callable = null)
 * @method static \PNS\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \PNS\Admin\Layout\Content content(\Closure $callable = null)
 ...
 * @method static bool usePluginAsset($plugin)
