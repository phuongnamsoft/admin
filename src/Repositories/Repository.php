...
namespace PNS\Admin\Repositories;

use PNS\Admin\Contracts\Repository as RepositoryInterface;
use PNS\Admin\Contracts\TreeRepository;
use PNS\Admin\Form;
use PNS\Admin\Grid;
use PNS\Admin\Show;
...
abstract class Repository implements RepositoryInterface, TreeRepository
{
     ...
     *
     * @param  Form  $form
     * @return int|bool|\PNS\Admin\Http\JsonResponse
     */
     ...
     *
     * @param  Form  $form
     * @return bool|\PNS\Admin\Http\JsonResponse
     */
     ...
     * @return bool|int|\PNS\Admin\Http\JsonResponse
     */
