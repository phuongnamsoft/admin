...
class Scheduling extends Extension
{
    ...
    protected static function registerRoutes()
    {
        parent::routes(function ($router) {
            ...
            $router->get('scheduling', 'PNS\Admin\Extensions\Scheduling\SchedulingController@index')->name('scheduling-index');
            $router->post('scheduling/run', 'PNS\Admin\Extensions\Scheduling\SchedulingController@runEvent')->name('scheduling-run');
        });
    }
