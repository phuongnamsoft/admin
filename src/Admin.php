...
use PNS\Admin\Controllers\AuthController;
use PNS\Admin\Layout\Content;
use PNS\Admin\Traits\HasAssets;
use PNS\Admin\Widgets\Navbar;
...
class Admin
{
     ...
     * @param Closure $callable
     *
     * @return \PNS\Admin\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \PNS\Admin\Widgets\Navbar
     */
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\PNS\Admin\Controllers')->group(function ($router) {
                ...
                $router->post('auth/extensions/{id}/install', 'ExtensionController@install')->names('admin.auth.extensions.install');
