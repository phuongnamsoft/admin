...
class Manager
{
    ...
    public function resolveExtension(string $directory, bool $addPsr4 = true)
    {
        ...
        $serviceProvider = $composerProperty->get('extra.pns-admin');
     ...
     * 添加扩展.
     *
     * @param  \PNS\Admin\Extend\ServiceProvider  $serviceProvider
     */
    ...
    protected function checkFiles($directory)
    {
        ...
        if (! $composerProperty->name || ! $composerProperty->get('extra.pns-admin')) {
            return false;
        }
