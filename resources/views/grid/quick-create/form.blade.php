...
<tr class="{{ $elementClass }} quick-create" style="cursor: pointer">
    <td colspan="{{ $columnCount }}" style="background: {{ PNS\Admin\Admin::color()->darken('#ededed', 1) }}">
