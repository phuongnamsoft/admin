    ...
    class Action {
        ...
        init() {
            ...
            $(options.selector).off(options.event).on(options.event, function (e) {
                ...
                if (conform) {
                    PNS.confirm(conform[0], conform[1], request);
                } else {
                    request()
                }
            });
        ...
        resolve() {
            ...
            return function (result) {
                ...
                PNS.handleJsonResponse(response, {html: options.html, target: target});
            };
        }
        ...
        reject() {
            ...
            return function (result) {
                ...
                if (request && typeof request.responseJSON === 'object') {
                    PNS.error(request.responseJSON.message)
                }
