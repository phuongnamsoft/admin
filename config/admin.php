...
return [
    ...
    */
    'auth' => [
        ...
        'controller' => PNS\Admin\Controllers\AuthController::class,
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => PNS\Admin\Auth\Database\Administrator::class,
            ],
        ],
    ...
    */
    'database' => [
        ...
        'users_model' => PNS\Admin\Auth\Database\Administrator::class,

        // Role table and model.
        'roles_table' => 'admin_roles',
        'roles_model' => PNS\Admin\Auth\Database\Role::class,

        // Permission table and model.
        'permissions_table' => 'admin_permissions',
        'permissions_model' => PNS\Admin\Auth\Database\Permission::class,
