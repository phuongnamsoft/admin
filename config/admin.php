   ...
   */
    ...
    */
    'auth' => [
        ...
        'providers' => [
            'admin' => [
                'driver' => 'eloquent',
                'model'  => PNS\Admin\Models\Administrator::class,
            ],
        ],
    ...
    */
    'grid' => [
        ...
        'batch_action_class' => PNS\Admin\Grid\Tools\BatchActions::class,

        // The global Grid pagination display class.
        'paginator_class' => PNS\Admin\Grid\Tools\Paginator::class,

        'actions' => [
            'view' => PNS\Admin\Grid\Actions\Show::class,
            'edit' => PNS\Admin\Grid\Actions\Edit::class,
            'quick_edit' => PNS\Admin\Grid\Actions\QuickEdit::class,
            'delete' => PNS\Admin\Grid\Actions\Delete::class,
            'batch_delete' => PNS\Admin\Grid\Tools\BatchDelete::class,
        ],

        // The global Grid column selector setting.
        'column_selector' => [
            'store' => PNS\Admin\Grid\ColumnSelector\SessionStore::class,
            'store_params' => [
                'driver' => 'file',
            ],
        ],
    ...
    */
    'database' => [
        ...
        'users_model' => PNS\Admin\Models\Administrator::class,

        // Role table and model.
        'roles_table' => 'admin_roles',
        'roles_model' => PNS\Admin\Models\Role::class,

        // Permission table and model.
        'permissions_table' => 'admin_permissions',
        'permissions_model' => PNS\Admin\Models\Permission::class,

        // Menu table and model.
        'menu_table' => 'admin_menu',
        'menu_model' => PNS\Admin\Models\Menu::class,
    ...
    */
    ...
    |
    */
    'exception_handler' => PNS\Admin\Exception\Handler::class,
